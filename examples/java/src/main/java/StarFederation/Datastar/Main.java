...
public class Main {
    ...
    private static void configureRoutes(ServletContextHandler context) {
        ...
        addRoute(context, "/patch", () -> context.addServlet(new ServletHolder(new MergeSignalsServlet()), "/patch"));
        ...
        addRoute(context, "/removeSignals", () -> context.addServlet(new ServletHolder(new RemoveSignalsServlet()), "/removeSignals"));
        ...
        addRoute(context, "/executeScript", () -> context.addServlet(new ServletHolder(new ExecuteScriptServlet()), "/executeScript"));
