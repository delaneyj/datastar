    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            String fragment = String.format(
                    "<button id='target' class=\"w-full p-3 bg-purple-700 text-white font-semibold rounded hover:opacity-80 transition\" data-on-click=\"sse('/removeTarget', {method: 'get'})\">Remove Target (morphed at %s)</button>",
                    today
            );
