	...
	sidebarGroups := []*SidebarGroup{
		{
			...
			Links: []*SidebarLink{
				...
				{ID: "GetComputedError"},
				{ID: "IndicatorKeyNotAllowed"},
				{ID: "IndicatorValueNotProvided"},
				{ID: "IntersectsKeyNotAllowed"},
				...
				{ID: "ReplaceUrlKeyNotAllowed"},
				{ID: "ReplaceUrlValueNotProvided"},
				{ID: "RequiredPluginNotLoaded"},
				{ID: "ScrollIntoViewKeyNotAllowed"},
				{ID: "ScrollIntoViewValueNotAllowed"},
				{ID: "ShowKeyNotAllowed"},
