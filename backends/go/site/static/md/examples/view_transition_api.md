...
<button class="flex flex-col items-center justify-center w-full gap-2 p-4 font-bold text-center no-underline rounded-md cursor-pointer bg-accent-600 hover:bg-accent-700 font-brand text-accent-50" data-show="$supportsViewTransitionAPI" data-on-click="$$get('/examples/view_transition_api/watch')">
    Fade transition
</button>
<button class="flex flex-col items-center justify-center w-full gap-2 p-4 font-bold text-center no-underline rounded-md cursor-pointer bg-accent-600 hover:bg-accent-700 font-brand text-accent-50" data-show="$supportsViewTransitionAPI" data-on-click="$useSlide = true; $$get('/examples/view_transition_api/watch')">
    Slide transition
</button>
</div>
</div>
