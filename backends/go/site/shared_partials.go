	...
	return Group(
		...
		HTML().
			...
			Children(
				...
				cdnScript("@unocss/runtime/preset-typography.global.js"),
				cdnScript("@unocss/runtime/preset-web-fonts.global.js"),
				cdnScript("@unocss/runtime/preset-uno.global.js"),
				SCRIPT().Text(`
window.__unocss = {
	presets: [
			...
			"accent": {
			  ...
			  "error": {
				...
				"900": "#3b1f15"
						...
						`),
				cdnScript("@unocss/runtime/uno.global.js"),
				SCRIPT().
					TYPE("module").
...
func cdnScript(src string) ElementRenderer {
	return SCRIPT().SRC("https://cdn.jsdelivr.net/npm/" + src)
}
